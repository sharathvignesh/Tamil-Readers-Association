<?php /*%%SmartyHeaderCode:26230550bbab9890743-79882903%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7556149bffd93a32040b52049a269b6d787d6638' => 
    array (
      0 => '.\\templates\\admin_reg.tpl',
      1 => 1426832247,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '26230550bbab9890743-79882903',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_550bbb8da717c0_13384757',
  'has_nocache_code' => false,
  'cache_lifetime' => 5,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_550bbb8da717c0_13384757')) {function content_550bbb8da717c0_13384757($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
         ...
         <div class="row">
          <div class="col-lg-8 col-xs-12 heading" style="margin-left: 294px;">
           <h1 class="admin_heading" style="color:rgb(83, 145, 153); font-size: 50px; font-weight: 800;">Admin Registration Page</h1>
            ...
            <div class="col-lg-6 col-lg-push-3">    
            <input type="password" placeholder="" class="form-control" style="width:43%;">
            </div>
            </div>
            <div class="row">
             <div class="col-lg-3 col-lg-push-3">
            ...
            <div class="col-lg-6 col-lg-push-3">    
            <input type="text" placeholder="" class="form-control" style="width:43%; height:100px;">
            </div>
            </div>
            <br>
            <div class="row">
