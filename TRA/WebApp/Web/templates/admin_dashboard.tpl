      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
                  {foreach from=$admin item=row}
                <tr class="click-row" data-href= "userProfile.php?id={$row.id}">
                  <td>{$row.id}</td>
                  <td>{$row.firstname}</td>    
                  <td>{$row.lastname}</td>
                  <td>{$row.role}</td>
       ...
       <div class="user" ng-app="" ng-show="myVar2">
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
         ...
         <form id="formdel" class="form-horizontal check-element animate-show" method="post" action="deleteUser.php" role="form"  ng-app="" name="myForm3" novalidate ng-show="formdel" ng-animate="{literal}{show: 'fadeIn'}{/literal}" style="position:relative;top:50px;">
