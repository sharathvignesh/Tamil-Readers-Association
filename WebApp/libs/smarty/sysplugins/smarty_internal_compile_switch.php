...
class Smarty_Internal_Compile_Switch extends Smarty_Internal_CompileBase {
 ...
 * @param Smarty_Internal_Compile $smarty
 * @return string
 */
...
class Smarty_Internal_Compile_Case extends Smarty_Internal_CompileBase {
...
class Smarty_Internal_Compile_Default extends Smarty_Internal_CompileBase {
...
class Smarty_Internal_Compile_Caseclose extends Smarty_Internal_CompileBase { 
    public $required_attributes = array();
    public $optional_attributes = array();
    public $shorttag_order = array();
...
class Smarty_Internal_Compile_Switchclose extends Smarty_Internal_CompileBase { 
    public $required_attributes = array();
    public $optional_attributes = array();
    public $shorttag_order = array();
