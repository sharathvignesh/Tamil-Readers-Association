...
<?php if (!$no_render) {?><?php if (!is_callable('smarty_modifier_capitalize')) include 'C:\wamp\www\Smarty_latest\libs\plugins\modifier.capitalize.php';
...
The current date and time is 2010-12-22 06:14:45

The value of global assigned variable $SCRIPT_NAME is /Smarty_latest/demo/index.php
...
testing strip tags
<table border=0><tr><td><A HREF="/Smarty_latest/demo/index.php"><font color="red">This is a  test     </font></A></td></tr></table>
